    ...
    public class ArticleTopicService : IArticleTopicService
    {
        ...
        public async Task<ArticleToReturnDto> GetArticleById(string id)
        {
            ...
            new SubTopic {Contributor_ = new ArticleContributor{
                ...
                SubTopicName = x.SubTopic, Text = x.ArticleText,
                DateCreated = x.DateCreated, DatePublished=x.DatePublished, SubId = x.Id,
            ...
            articleToReturn.Articles = articleToReturn.Articles.OrderByDescending(x => x.DatePublished).Reverse().ToList();
        ...
        public bool CheckArtictleTopic(string ArticleTopic)
        {
