...
namespace DecaBlog.Data.Repositories.Interfaces
{
    public interface IArticleRepository
    {
        ...
        IQueryable<ArticleTopic> GetAllArticleTopicsWithPublishedArticles();
        ...
        Task<bool> AddLikeToArticleTopic(UserLike model);
        Task<bool> CheckIfUserLikeArticleTopic(User user, string topicId);
        Task<int> GetTotalLikes(string topicId);
        Task<bool> RemoveLikeFromArticleTopic(UserLike model);
        Task<Dictionary<int, int>> GetArticlesByMonth(int year);
    }
}