...
namespace DecaBlog.Data
{
    public class Seeder
    {
        ...
        public async Task SeedMe(string envName)
        {
            ...
            var roles = new string[] {"Admin", "Editor", "Decadev" };
            ...
            var path_userCommentSeed = "/app/UserCommentSeed.json";
            ...
            if (envName.Equals("Development"))
            {
                ...
                path_userCommentSeed = @"../DecaBlog.Data/UserCommentSeed.json";
            }
            ...
            var commentData = File.ReadAllText(path_userCommentSeed);
            var comments = JsonConvert.DeserializeObject<List<UserComment>>(commentData);
