...
{
    public partial class NewForSqlite : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserLikes", x => new { x.Id, x.LikerId, x.TopicId });
                    table.ForeignKey(
                        name: "FK_UserLikes_ArticleTopics_TopicId",
                        column: x => x.TopicId,
                        principalTable: "ArticleTopics",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserLikes_AspNetUsers_LikerId",
                        column: x => x.LikerId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CommentVotes", x => new { x.Id, x.VoterId, x.CommentId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CommentVotes_UserComments_CommentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserLikes_LikerId",
                table: "UserLikes",
                column: "LikerId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_UserLikes_TopicId",
                table: "UserLikes",
                column: "TopicId");
